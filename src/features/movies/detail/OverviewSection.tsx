...
// Read-only: the overview is catalogue copy, not the user's own writing (that
// is what Personal notes is for). Starts clamped to a few lines and expands on
// tap since some overviews run long.
