    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md animate-in fade-in duration-300">
            ...
            <div className="flex flex-col items-center justify-center w-full max-w-md p-6 space-y-8">
                ...
                <div
                    onClick={() =>
                        !isSpinning && winner && navigate(`/edit/${winner.id}`)
                    }
                    className={`relative aspect-[2/3] w-64 bg-neutral-900 rounded-xl shadow-2xl overflow-hidden border-4 ${
                        isSpinning
                            ? "border-neutral-800"
                            : "border-blue-500 shadow-[0_0_50px_rgba(16,185,129,0.4)]"
                    } transition-all duration-300 ${
                        !isSpinning && winner
                            ? "cursor-pointer hover:scale-105 hover:shadow-[0_0_60px_rgba(16,185,129,0.6)]"
                            : ""
                    }`}
                >
                    {currentMovie ? (
