...
// The discovery half of leaving-soon, on the Browse feed: things about to go
// that were never saved. The watchlist half lives in Browse → Calendar →
// Leaving, where someone goes on purpose; this row is for the case where they
// were not looking.
//
// Region-wide, not limited to services the user subscribes to — a rail of
// what is disappearing is a browse surface, and a title worth a subscription is
// worth showing. The row itself marks which services you already have.
//
